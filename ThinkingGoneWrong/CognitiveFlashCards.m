...
#import "CognitiveFlashCards.h"

@interface CognitiveFlashCards ()

@end

@implementation CognitiveFlashCards
...
- (void)viewDidLoad
{
    ...
    arrayQuestions = [NSArray arrayWithObjects:@"Ambiguity effect",
    ...
    arrayAnswers = [NSArray arrayWithObjects:@"The tendency to avoid options for which missing information makes the probability seem 'unknown.'",
